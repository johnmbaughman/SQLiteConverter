...
{
	public sealed class SQLiteToSqlServerConverter : BaseConverter
	{
		#region Public Methods
		public SQLiteToSqlServerConverter()
		{
			//Logging.Log(LogLevel.Info, "SqlServerConverter initialized");
		}

		public SQLiteToSqlServerConverter(List<TableToLoad> tablesToLoad)
		{
